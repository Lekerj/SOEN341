...
class QnATab {
    ...
    constructor(eventId = null, organizerId = null, options = {}) {
        ...
        this.answerForm = options.answerForm || null;
    ...
    createQuestionCard(question) {
        ...
        `;
        if (this.shouldShowAnswerButton(question)) {
            const actions = document.createElement('div');
            actions.className = 'question-actions';
            const answerBtn = document.createElement('button');
            answerBtn.type = 'button';
            answerBtn.className = 'answer-btn';
            answerBtn.textContent = 'Answer Question';
            answerBtn.addEventListener('click', (event) => {
                event.stopPropagation();
                this.handleAnswerQuestion(question);
            });
    ...
    updateOrganizerState() {
        ...
        this.isOrganizer = Boolean(this.currentUserId) && Boolean(this.organizerId) && Number(this.currentUserId) === Number(this.organizerId);

    }



    shouldShowAnswerButton(question) {

        return this.isOrganizer && this.answerForm && question && !(question.is_answered === true || question.is_answered === 1);
    ...
    handleAnswerQuestion(question) {
        ...
        if (!this.answerForm || !question) return;

        this.answerForm.setQuestion(question);
