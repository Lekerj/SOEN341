...
-- - This file can be re-run safely if user emails are present; duplicate events may be
--   created unless you add deduplication checks. Use a test database when running.
